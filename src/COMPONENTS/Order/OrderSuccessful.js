...
const OrderSuccessful = ({ orderid, message, redirecto }) => {
    ...
    const [orderdata, setorderdata] = useState({
        ...
        CustomerName: 'Nehal Tembhurkar',
        CustomerShipToAddress: 'Plot No.19, Ram Nagar, Khat Road, Near Shiv Uma Traders Bhandara, Maharashtra 441904',
        CustomerEmail: 'nehaltembhurkar19@gmail.com',
        OrderItems: [
            {
